...
public class SparkMaxDriveTrain extends DriveTrain {
    ...
    public void drive(double speed, double turnRate) {
        ...
        /*
         * The other software options that work with the drive train hardware that we're
         * using this year are arcadeDrive, which is just a worse version of
         * curvatureDrive, and tankDrive, where the driver controls each side of the
         * robot independently.
         */
    }
