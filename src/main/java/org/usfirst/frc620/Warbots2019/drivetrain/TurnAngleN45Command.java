...
public class TurnAngleN45Command extends Command {
  ...
  public TurnAngleN45Command(Angle amountToTurn) {
  ...
  protected void execute() {
    ...
    TurnAnglePIDCommand cmd = new TurnAnglePIDCommand(Angle.fromDegrees(45));
