...
public class ToggleRobotSpeedRangeCommand extends Command 
{
    private DriveTrain drivetrain;

    public ToggleRobotSpeedRangeCommand() 
    {
    ...
    {
    System.err.println("ToggleRobotSpeedRangeCommand: NOT IMPLEMENTED!");
    }
