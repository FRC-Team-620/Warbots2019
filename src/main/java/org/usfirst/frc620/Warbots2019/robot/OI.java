...
public class OI {
    ...
    public JoystickButton stowButton;
    public JoystickButton deployTazButton;
    ...
    public OI() {
        ...
        driverController = new Joystick(3);
        driverController = new Joystick(5);
        driverController = new Joystick(6);
        driverController = new Joystick(10);
        driverController = new Joystick(11);
        ...
        //stowButton = new JoystickButton(driverController, 10);
        //stowButton.whenPressed(new stow());

        //deployTazButton = new JoystickButton(driverController, 11);
        //deployTazButton.whenPressed(new deploy());
