 ...
 *
 */
public class ElevatorDance extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public ElevatorDance() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new MoveElevatorTo(Elevator.top));
        addParallel(new SpinOutOfControl());
        addSequential(new MoveElevatorTo(Elevator.bottom));
