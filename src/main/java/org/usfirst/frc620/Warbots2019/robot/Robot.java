...
public class Robot extends TimedRobot {
    ...
    static PIDElevator elevator;
    static AlignmentSystem alignmentSystem;
    static TrackingSystem trackingSystem;
    static CargoMech cargoMech; //Deep Space bot only
    static TazGrabber tazGrabber; //Taz only
    ...
    public void robotInit() {
        ...
        //cargoMech = new CargoMech(); //Deep space bot only
        tazGrabber = new TazGrabber(6, 2, 5, 7, 4, 2, 0, 3, 1); //Taz only
